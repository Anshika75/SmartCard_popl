  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#F1F1F1]">
      <div className="left w-full px-16 md:w-1/2 bg-white py-16 md:py-0 md:min-h-screen rounded-tr-3xl rounded-br-3xl flex flex-row items-center justify-center md:px-10 xl:px-20">
        <form className="box flex flex-col w-full">
          <div className="flex md:mb-0 xl:mb-6">
            <h1 className="text-3xl font-bold text-center text-black justHand">
              BixID &nbsp;
            </h1>
            <h1 className="text-xl font-normal text-center text-[#C9C9C9]  roboto">
              {" "}
              | Log in
            </h1>
          </div>
          ...
          <div className="my-4">
            ...
            <p className="block text-[#DBDBDB] text-sm roboto font-bold text-center">
              <span className="relative before:absolute before:top-[50%] before:left-0 before:translate-x-[-110%] before:h-[2px] before:w-[100px] before:bg-[#DBDBDB] after:absolute after:top-[50%] after:right-0 after:translate-x-[110%] after:h-[2px] after:w-[100px] after:bg-[#dbdbdb]">
                OR
              </span>
            </p>
            <button className="bg-white text-black border border-black w-full py-2 px-3 rounded-3xl mt-8 mb-6 flex justify-center items-center">
              {" "}
              <img src={Google} alt="" className="mr-3 scale-90" /> Continue
              with Google
            </button>
            <button className="bg-white text-black border border-black w-full py-2 px-3 rounded-3xl flex justify-center items-center">
              {" "}
              <img src={Microsoft} alt="" className="mr-3 scale-75" /> Continue
              with Microsoft
            </button>
            <p className="block text-black text-sm roboto font-semibold mt-4 text-center">
              New to BixID ?{" "}
              <span className="text-[#67ABFA]">Create Account</span>
            </p>
          </div>
        </form>
      </div>
      ...
      <div className="right relative flex flex-col items-center justify-end w-full my-12 md:my-0 md:pb-20 px-20">
        ...
        <p className="block text-black text-xl roboto font-bold my-2 text-center">
          Trusted By
        </p>
